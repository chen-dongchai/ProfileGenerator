            ...
            switch (shapeDefinition.ShapeName)
            {
                case "CircleOutline":

                    {
                        ...
                        Arc arc1 = Arc.Create(center, circleOutline.RadiusFt - 2 * gapFt, 0, 1 * Math.PI, XYZ.BasisX, XYZ.BasisY);
                        Arc arc2 = Arc.Create(center, circleOutline.RadiusFt - 2 * gapFt, 1 * Math.PI, 2 * Math.PI, XYZ.BasisX, XYZ.BasisY);
                ...
                case "RectangleOutline":
                    {
                        ...
                        {
                            double halfWidthFt = (rectangleOutline.WidthFt - 2 * gapFt) / 2;
                            double halfHeightFt = (rectangleOutline.HeightFt - 2 * gapFt) / 2;
                ...
                case "WallOutline":
                    {
                        WallOutline wallOutline = shapeDefinition as WallOutline;
                        List<Curve> curves = new List<Curve>();
                        double halfWidthFt = (wallOutline.lengthFt - 2*gapFt) / 2;
                        double halfHeightFt = (wallOutline.heightFt - 2*gapFt) / 2;
                        XYZ p1 = new XYZ(-halfWidthFt, halfHeightFt, 0);
                        XYZ p2 = new XYZ(halfWidthFt, halfHeightFt, 0);
                        XYZ p3 = new XYZ(halfWidthFt, -halfHeightFt, 0);
                        XYZ p4 = new XYZ(-halfWidthFt, -halfHeightFt, 0);
